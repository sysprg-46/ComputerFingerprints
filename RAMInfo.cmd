...
REM Run JS-script
echo Running %windir%\System32\CScript.exe COMPInfo.js /select:ram //NOLOGO
%windir%\System32\CScript.exe %JSName%.js /select:ram //NOLOGO>%log%
